<div class="modal-body">
    ...
    {!! Form::hidden('latitudestart', null, ['id' => 'latitude-start']) !!}
    {!! Form::hidden('longitudestart', null, ['id' => 'longitude-start']) !!}
    {!! Form::hidden('latitudefinal', null, ['id' => 'latitude-final']) !!}
    {!! Form::hidden('longitudefinal', null, ['id' => 'longitude-final']) !!}
